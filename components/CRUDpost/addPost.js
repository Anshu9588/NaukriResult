...
export default function AddPost({ token, setPostState }) {
  const initialState = {
    metaTitle: "",
    metaKeywords: "",
    metaDiscription: "",
  ...
  const copyDataInput = useRef("");
  /// handling input using state
  ...
  async function addPost(user) {
    const sender = await fetch(`/api/admin/addpost`, {
      method: "POST",
      headers: {
  ...
  const copyDataInputHandler =async ()=>{
    const getPostData = copyDataInput.current.value
    ...
    setFormData({
      ...initialState,nameOfPost:fetchData.nameOfPost,metaTitle: fetchData.metaTitle,
      metaKeywords: fetchData.metaKeywords,
      metaDiscription: fetchData.metaDiscription,
      metaImageLink: fetchData.metaImageLink,
      MaxAge: fetchData.MaxAge,
      MinAge: fetchData.MinAge,
      category: fetchData.category,
      appAdmitCardDate: fetchData.appAdmitCardDate,
      appCustumDateLabel: fetchData.appCustumDateLabel,
      appCustumFeeLabel: fetchData.appCustumFeeLabel,
      appExamDate: fetchData.appExamDate,
      appFeeLastDate: fetchData.appFeeLastDate,
      appGeneralFemaleFee: fetchData.appGeneralFemaleFee,
      appGeneralMAleFee: fetchData.appGeneralMAleFee,
      appLastDate: fetchData.appLastDate,
      appReserverMaleFee: fetchData.appReserverMaleFee,
      appReserverFemaleFee: fetchData.appReserverFemaleFee,
      appStartDate: fetchData.appStartDate,
      applyLink: fetchData.applyLink,
      custumAgeLabel: fetchData.custumAgeLabel,
      custumLinkLabel: fetchData.custumLinkLabel,
      dateOfPost: fetchData.dateOfPost,
      howToFillForm: fetchData.howToFillForm,
      nameOfPost: "",
      postAgeLimit: fetchData.postAgeLimit,
      postDescription: fetchData.postDescription,
      postEligibility: fetchData.postEligibility,
      custumPostDetails: fetchData.custumPostDetails,
      seoHeading1: fetchData.seoHeading1,
      seoHeadingh2: fetchData.seoHeadingh2,
      seoHeadingh3: fetchData.seoHeadingh3,
      seoHeadingh4: fetchData.seoHeadingh4,
      stepToFillForm: fetchData.stepToFillForm,
      vacencyHeading: fetchData.vacencyHeading,
      questionAnswer: fetchData.questionAnswer,
      linkHeading:!fetchData.linkHeading? "Some Important Links":fetchData.linkHeading,
    });
  }
  return (
    
    <form onSubmit={submitHandler}>
      <div className="my-3"><label> Enter post url to copy data</label><input className="border border-gray-700 w-1/2" ref={copyDataInput} name="copyDataInput" placeholder="enter last url " ></input> <div className="w-max px-2 py-1 border-blue border" onClick={copyDataInputHandler}>Copy Data</div></div>
      <div>
              ...
              <tr className="border-y border-gray-700 border-collapse ">
                ...
                <td colSpan="4">
                  ...
                  <ul className="px-2">
                    ...
                    <div
                      className="border border-blue px-2 py-1 w-max"
                      onClick={() =>
                        addItemHandler(
                          "appCustumFeeLabel",
                ...
                <td colSpan="8">
                  ...
                  <ul className="px-3">
                    ...
                    <div
                      className="border border-blue px-2 py-1 w-max"
                      onClick={() =>
                        addItemHandler("custumAgeLabel", "custumAgeLabelValue")
                      }
                    >
                      Add
                    </div>
                    <div
                      className="border border-blue px-2 py-1 w-max"
                      onClick={() => resetItemHandler("custumAgeLabel")}
                    >
                      Reset
                    </div>
                  </ul>
                ...
                <td colSpan="4">
                  <ul>
                    <li>
                      ...
                      <div
                        className="border border-blue px-2 py-1 w-max"
                        onClick={() => resetItemHandler("eligibilityDetails")}
                      >
                        Reset
                      </div>
                    </li>
                ...
                <td colSpan="8">
                  <h2 className="border-y text-center w-full  border-collapse border-gray-700 text-green text-2xl ">
                    <strong>
                      <input
                        className="w-full "
                        value={formData.linkHeading}
                        placeholder="post name for links"
                        type="text"
                        id="linkHeading"
                        name="linkHeading"
                        onChange={handleInputChange}
